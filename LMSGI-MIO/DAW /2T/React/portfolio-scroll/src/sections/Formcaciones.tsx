...
const Formaciones = () => {
    return (
        <section id="formaciones" className="min-h-screen w-full bg-gray-900">
            <div className="py-24 sm:py-22 w-full">
                <div className="mx-auto max-w-screen-2xl px-6 lg:px-12">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        <h2 className="text-4xl font-semibold tracking-tight text-pretty text-white-950 sm:text-5xl">
                        ...
                        {titulos.map((titulo) => (
                            <article key={titulo.id}
                                className="flex max-w-xl flex-col items-start justify-between
                                                       rounded-md border-2 border-text-500 p-3 hover:bg-gray-800
                                            ">
