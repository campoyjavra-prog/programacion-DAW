...
public class Actividad3 {
    ...
    public static void main(String[] args) {
        ...
        // Lectura de datos
        objeto.leerDatos("/Users/rafacamjv/Desktop/CICLOS/1DAW/GitHub/PROGRAMACION/programacion-DAW/T5/numeros.txt");
        System.out.println("Victorias jugador1= " + objeto.getPartidasJugador1() + ". Victorias jugador2= "
                + objeto.getPartidasJugador2());
        // Modificar tras la partida ...
        objeto.IncrementaPartidasJugador1(1);
        objeto.IncrementaPartidasJugador2(3);
        // Guardar los datos
        objeto.guardarDatos("/Users/rafacamjv/Desktop/CICLOS/1DAW/GitHub/PROGRAMACION/programacion-DAW/T5/numeros.txt");
    ...
    public void leerDatos(String ruta) {
        ...
        if (!fichero.exists())
            return; // Si no existe, empezamos en 0
