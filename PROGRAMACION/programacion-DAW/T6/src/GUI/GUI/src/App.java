...
public class App extends JDialog {
    ...
    private void initComponents() {
        ...
        botonRestar.addActionListener(e -> resultado.setText("El resultado es: " +
                (Integer.parseInt(campoDeTexto1.getText()) - Integer.parseInt(campoDeTexto2.getText()))));
        ...
        panelDeContenido.add(botonSumar);
        panelDeContenido.add(botonRestar);
    ...
    // numClicks++;
    // campoDeTexto1.setText(String.valueOf(numClicks));
    // }
