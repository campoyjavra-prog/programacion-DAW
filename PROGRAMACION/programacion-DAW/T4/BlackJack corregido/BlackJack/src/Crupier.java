...
public class Crupier {
    ...
    public void mostrarMano() {
        ...
        System.out.println("Puntuación del Crupier: " + obtenerPuntuacion());
    }

    // Método para determinar si el crupier debe seguir pidiendo cartas
    public boolean debePedirCarta() {
        return obtenerPuntuacion() < 17;  // El crupier sigue pidiendo cartas si tiene menos de 17 puntos
    }
}