...
public class Jugador {
    ...
    public void mostrarMano() {
        ...
        // Mostrar la puntuación total del jugador
        System.out.println("Puntuación total: " + obtenerPuntuacion());
    }

    // Método para restablecer la mano del jugador para una nueva ronda
    public void restablecerMano() {
        mano.clear();
    }
